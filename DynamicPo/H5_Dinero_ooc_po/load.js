...
var H5_Dinero_ooc_po = (function (_super) {
    __extends(H5_Dinero_ooc_po, _super);
    function H5_Dinero_ooc_po(configUrl) {
        return _super.call(this, configUrl) || this;
    }
    Object.defineProperty(H5_Dinero_ooc_po, "classAssetName", {
        get: function () {
            return "Standard_3862_" + GlobelSettings.language; //subclass must override
        },
        enumerable: true,
        configurable: true
    });
    H5_Dinero_ooc_po.prototype.init = function () {
        this.bgAssetName = "random_7289_" + GlobelSettings.language.toUpperCase() + "_png";
        _super.prototype.init.call(this);
        var closeBtnRect = new egret.Rectangle(707,131,34,36); //range of close button
        var comfirmBtnRect = new egret.Rectangle(359,547,215,71); //range of comfirm button
        var coinRect = new egret.Rectangle(265, 395, 410, 45);
        var coinColor = 0x94eb1a
        var priceRect = new egret.Rectangle(241, 495, 425, 45);
        var priceColor = 0xff0033;
        Com.addObjectAt(this, this.showLoyaltyPrivileges(), 740, 486);
        var forOnlyRect = new egret.Rectangle(243, 455, 425, 35);
        ...
        coinstxt.text = Utils.formatCoinsNumber(Math.round(Number(product["items"][0].after_discount_chips) * (1 + Number(loyaltyArr[loyaltyLevel]["purchase_chips"]))));
        // this.timerTxt = Com.addTextAt( this, 330, 210, 260, 26, 26, false, true );
        // this.timerTxt.text = 
pricetxt.size = 34;
forTx.size = 20;
        var loyaltyPointTxt = Com.addTextAt(this, 640, 586, 260, 21, 21, false, true);
    ...
    // }
    H5_Dinero_ooc_po.prototype.poOverplusOver = function () {
        this.onClose(null);
    };
    H5_Dinero_ooc_po.prototype.onRemove = function () {
        this.removeChildren();
        // this.addChild( this.bg );
        // this.addChild( this.closeButton );
    };
    H5_Dinero_ooc_po.prototype.buyProduct = function (event) {
        var ev = new egret.Event(GenericModal.MODAL_COMMAND);
        ev["cmd"] = "buyProduct";ev["productType"] = 1;
        this.dispatchEvent(ev);
    };
    H5_Dinero_ooc_po.prototype.createAlphaButton = function (rect, fun) {
    ...
    H5_Dinero_ooc_po.prototype.createText = function (rect, color, useFilters, bold) {
    ...
    H5_Dinero_ooc_po.prototype.createCoinsTest = function (rect, color, txt, size, dropShaddow) {
    ...
    return H5_Dinero_ooc_po;
}(TimerPo));
__reflect(H5_Dinero_ooc_po.prototype, "H5_Dinero_ooc_po");
