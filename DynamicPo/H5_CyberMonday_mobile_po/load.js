...
var H5_CyberMonday_mobile_po = (function (_super) {
    __extends(H5_CyberMonday_mobile_po, _super);
    function H5_CyberMonday_mobile_po(configUrl) {
        return _super.call(this, configUrl) || this;
    }
    Object.defineProperty(H5_CyberMonday_mobile_po, "classAssetName", {
        get: function () {
            return "Standard_7164_" + GlobelSettings.language; //subclass must override
        },
        enumerable: true,
        configurable: true
    });
    H5_CyberMonday_mobile_po.prototype.init = function () {
        this.bgAssetName = "random_8791_" + GlobelSettings.language.toUpperCase() + "_png";
        _super.prototype.init.call(this);
        var closeBtnRect = new egret.Rectangle(796,175,31,33); //range of close button
        var comfirmBtnRect = new egret.Rectangle(346,569,222,75); //range of comfirm button
        var coinRect = new egret.Rectangle(232, 474, 410, 45);
        var coinColor = 0xffe25a;
        var priceRect = new egret.Rectangle(244, 584, 425, 45);
        var priceColor = 0xFFFFFF;
        Com.addObjectAt(this, this.showLoyaltyPrivileges(), 135, 533);
        ...
        this.timerTxt = Com.addTextAt( this, 330, 360, 260, 26, 26, false, true );
        this.timerTxt.text = "00:00:00";
pricetxt.size = 38;
        var loyaltyPointTxt = Com.addTextAt(this, 595, 635, 260, 21, 21, false, true);
    ...
    H5_CyberMonday_mobile_po.prototype.updateDealOverplusText = function(time) {
        if( this.timerTxt ) this.timerTxt.text = Utils.secondToHour( time );
    }
    H5_CyberMonday_mobile_po.prototype.poOverplusOver = function () {
        this.onClose(null);
    };
    H5_CyberMonday_mobile_po.prototype.onRemove = function () {
        this.removeChildren();
        // this.addChild( this.bg );
        // this.addChild( this.closeButton );
    };
    H5_CyberMonday_mobile_po.prototype.buyProduct = function (event) {
        var ev = new egret.Event(GenericModal.MODAL_COMMAND);
        ev["cmd"] = "buyProduct";
        this.dispatchEvent(ev);
    };
    H5_CyberMonday_mobile_po.prototype.createAlphaButton = function (rect, fun) {
    ...
    H5_CyberMonday_mobile_po.prototype.createText = function (rect, color, useFilters, bold) {
    ...
    H5_CyberMonday_mobile_po.prototype.createCoinsTest = function (rect, color, txt, size, dropShaddow) {
...
return bitmap;
    ...
    return H5_CyberMonday_mobile_po;
}(TimerPo));
__reflect(H5_CyberMonday_mobile_po.prototype, "H5_CyberMonday_mobile_po");
