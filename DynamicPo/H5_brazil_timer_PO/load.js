...
var H5_brazil_timer_PO = (function (_super) {
    __extends(H5_brazil_timer_PO, _super);
    function H5_brazil_timer_PO(configUrl) {
        return _super.call(this, configUrl) || this;
    }
    Object.defineProperty(H5_brazil_timer_PO, "classAssetName", {
        get: function () {
            return "Standard_4532_" + GlobelSettings.language; //subclass must override
        },
        enumerable: true,
        configurable: true
    });
    H5_brazil_timer_PO.prototype.init = function () {
        this.bgAssetName = "random_9585_" + GlobelSettings.language.toUpperCase() + "_png";
        _super.prototype.init.call(this);
        var closeBtnRect = new egret.Rectangle(661,100,37,27); //range of close button
        var comfirmBtnRect = new egret.Rectangle(353,589,232,49); //range of comfirm button
        var coinRect = new egret.Rectangle(285, 381, 410, 45);
        var coinColor = 0xffe25a;
        var priceRect = new egret.Rectangle(253, 547, 425, 45);
        var priceColor = 0xFFFFFF;
        var disCountRect = new egret.Rectangle(382, 451, 225, 35);
        var disCountColor = 0x94eb1a;
        Com.addObjectAt(this, this.showLoyaltyPrivileges(), 590, 522);
        var forOnlyRect = new egret.Rectangle(252, 508, 425, 35);
...
coinsText2.texture = RES.getRes("Po_icons_json.dinero");
        ...
        this.timerTxt = Com.addTextAt( this, 330, 322, 260, 26, 26, false, true );
        this.timerTxt.textColor = 0;
pricetxt.size = 34;
forTx.size = 25;
        var loyaltyPointTxt = Com.addTextAt(this, 654, 484, 260, 21, 21, false, true);
    ...
    H5_brazil_timer_PO.prototype.updateDealOverplusText = function name(time){
        if( this.timerTxt ) this.timerTxt.text = Utils.secondToHour( time );
    }
    H5_brazil_timer_PO.prototype.poOverplusOver = function () {
        this.onClose(null);
    };
    H5_brazil_timer_PO.prototype.onRemove = function () {
        this.removeChildren();
        // this.addChild( this.bg );
        // this.addChild( this.closeButton );
    };
    H5_brazil_timer_PO.prototype.buyProduct = function (event) {
        var ev = new egret.Event(GenericModal.MODAL_COMMAND);
        ev["cmd"] = "buyProduct";ev["productType"] = 2;
        this.dispatchEvent(ev);
    };
    H5_brazil_timer_PO.prototype.createAlphaButton = function (rect, fun) {
    ...
    H5_brazil_timer_PO.prototype.createText = function (rect, color, useFilters, bold) {
    ...
    H5_brazil_timer_PO.prototype.createCoinsTest = function (rect, color, txt, size, dropShaddow) {
    ...
    H5_brazil_timer_PO.prototype.createDisCountLine = function (disCount) {
    ...
    return H5_brazil_timer_PO;
}(TimerPo));
__reflect(H5_brazil_timer_PO.prototype, "H5_brazil_timer_PO");
