...
var H5_Brasil_timer_wheel_po = (function (_super) {
    __extends(H5_Brasil_timer_wheel_po, _super);
    function H5_Brasil_timer_wheel_po(configUrl) {
        return _super.call(this, configUrl) || this;
    }
    Object.defineProperty(H5_Brasil_timer_wheel_po, "classAssetName", {
        get: function () {
            return "Standard_2180_" + GlobelSettings.language; //subclass must override
        },
        enumerable: true,
        configurable: true
    });
    H5_Brasil_timer_wheel_po.prototype.init = function () {
        this.bgAssetName = "random_7251_" + GlobelSettings.language.toUpperCase() + "_png";
        _super.prototype.init.call(this);
        var closeBtnRect = new egret.Rectangle(705,47,35,34); //range of close button
        var comfirmBtnRect = new egret.Rectangle(350,607,254,66); //range of comfirm button
        var coinRect = new egret.Rectangle(261, 424, 410, 45);
        var coinColor = 0xffe25a;
        var priceRect = new egret.Rectangle(257, 488, 425, 45);
        var priceColor = 0xffffff;
        Com.addObjectAt(this, this.showLoyaltyPrivileges(), 640, 571);
        ...
        this.timerTxt = Com.addTextAt( this, 330, 340, 260, 26, 26, false, true );
        // this.timerTxt.text = "00:00:00"
        this.timerTxt.textColor = 0xff7e03;
pricetxt.size = 32;
        var loyaltyPointTxt = Com.addTextAt(this, 712, 548, 260, 21, 21, false, true);
    ...
    H5_Brasil_timer_wheel_po.prototype.updateDealOverplusText = function (time) {
        if (this.timerTxt)
            this.timerTxt.text = Utils.secondToHour(time);
    };
    H5_Brasil_timer_wheel_po.prototype.poOverplusOver = function () {
        this.onClose(null);
    };
    H5_Brasil_timer_wheel_po.prototype.onRemove = function () {
        this.removeChildren();
        // this.addChild( this.bg );
        // this.addChild( this.closeButton );
    };
    H5_Brasil_timer_wheel_po.prototype.buyProduct = function (event) {
        var ev = new egret.Event(GenericModal.MODAL_COMMAND);
        ev["cmd"] = "buyProduct";
        this.dispatchEvent(ev);
    };
    H5_Brasil_timer_wheel_po.prototype.createAlphaButton = function (rect, fun) {
    ...
    H5_Brasil_timer_wheel_po.prototype.createText = function (rect, color, useFilters, bold) {
    ...
    H5_Brasil_timer_wheel_po.prototype.createCoinsTest = function (rect, color, txt, size, dropShaddow) {
...
return bitmap;
    ...
    return H5_Brasil_timer_wheel_po;
}(TimerPo));
__reflect(H5_Brasil_timer_wheel_po.prototype, "H5_Brasil_timer_wheel_po");
